...
return {
   ...
   -- flat buttons
   CLICKABLE = 0x000000,
   CLICKABLE_HOVER = 0x40130f,             -- Color when hovering over the tab with mouse
   ...
   -- for 3D surfaces
   THREE_D_HIGHLIGHT = 0x40130f,            -- Color of outside-most window border color, resizer, tab borders, and scrollbar highlights

   THREE_D_GRADIENT = miniwin.gradient_vertical,
   THREE_D_GRADIENT_FIRST = 0x000000,
   THREE_D_GRADIENT_SECOND = 0x40130f,
   ...
   SCROLL_TRACK_COLOR2 = 0x40130f,          -- Main color of scrollbar
